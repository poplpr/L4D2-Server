...
public void OnPluginStart() {
	...
	g_hCVar_NextMapMenuExcludes = CreateConVar("acs_next_map_menu_excludes", "1", "Excludes certain map(s) from the map voting menu [0 = Nothing(Default), 1 = Current map ]");
